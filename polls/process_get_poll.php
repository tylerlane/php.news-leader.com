...
else
{
	...
	if(  !$error  )
	{
		...
		if( empty( $_COOKIE[ $cookie_name ] ) )
		{
			...
			$poll = "<div id='poll'>";
			$poll .= "<div class=\"box-head\"><h2 id='poll_title'>". $row[ "poll_title" ] ."</h2>";
			...
			$poll .= "<input value=\"Vote\" style='font-weight: bold; border:0px; height: 41px; margin-top: 10px;' type='button' id='vote_button' >";
			$poll .= "</div>";
