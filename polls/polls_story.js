$(function() {
	...
	$("input:image").live( "click", function()
	{
		...
		if( option_id != undefined || option_id != "" )
		{
			...
			//Omniture Code
			GEL.thepage.viewTracker.setAttribute("Recording Vote", poll_id );
			GEL.thepage.viewTracker.trackLink("polls");
		}
		return false;
	} );
	...
	$("#display_results" ).live( "click", function()
	{
		...
		//Omniture Code
		GEL.thepage.viewTracker.setAttribute("Displaying Results", poll_id );
		GEL.thepage.viewTracker.trackLink("polls");
	});
	...
	$("#display_poll" ).live( "click", function()
	{
		...
		//Omniture Code
		GEL.thepage.viewTracker.setAttribute("Displaying Poll", poll_id );
		GEL.thepage.viewTracker.trackLink("polls");
	});
