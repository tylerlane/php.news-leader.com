...
<html lang="en">
<head>
<title>News-Leader.com | Joplin Tornado Cleanup - Before and After Interactive</title>
...
$(document).ready(function() {
    ...
    $('#secondImage').css("visibility","visible");
...
<!--linking to our stylesheet -->
<link rel="stylesheet" type="text/css" href="cleanup_style.css">
<!--- OAS MACRO --->
<script> 
<!--
//configuration
...
OAS_sitepage='mo-springfield.ozarksnow.com/news/article.htm';
//endconfiguration
OAS_version = 10;
    ...
    <div class="ody-custom">
        <div class="main-container">
            <div class="ody-wrapper">
                <div style="margin-top:25px;margin-bottom:25px;" id="ad">
                    <script>
                    <!--
                        OAS_AD('728x90_1');
                        //-->
                ...
                <div class="headerSection ">
                    <div class="sectionName clearfix">
                        <div class="left">
                            <h1>Joplin Tornado: Interactive</h1>
                            <span id="socialtrack" class="socialitems">
                            <iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fphp.news-leader.com%2Fjoplin%2Fcleanup1.php&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" ref="secheader" style="border:none; overflow:hidden; width:90px; height:20px;" allowtransparency="true" frameborder="0" scrolling="no"></iframe>
                            <script type="text/javascript" src="http://apis.google.com/js/plusone.js"></script>
                            <script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
                            <iframe title="" style="width: 180px; height: 20px;" class="twitter-follow-button" src="http://platform.twitter.com/widgets/follow_button.html#_=1313618227396&amp;align=&amp;button=blue&amp;id=twitter_tweet_button_0&amp;lang=en&amp;link_color=&amp;screen_name=springfieldNL&amp;show_count=false&amp;show_screen_name=&amp;text_color=" allowtransparency="true" frameborder="0" scrolling="no"></iframe>
                            <div style="height: 20px; width: 90px; display: inline-block; text-indent: 0pt; margin: 0pt; padding: 0pt; background: none repeat scroll 0% 0% transparent; border-style: none; float: none;" id="___plusone_0"><iframe allowtransparency="true" hspace="0" id="I1_1313618223575" marginheight="0" marginwidth="0" name="I1_1313618223575" src="https://plusone.google.com/u/0/_/+1/fastbutton?url=http%3A%2F%2Fwww.News-Leader.com%2Fjoplin%2Fcleanup1.php&amp;size=medium&amp;count=true&amp;annotations=&amp;hl=en-US&amp;jsh=r%3Bgc%2F23123384-f8bf5791#id=I1_1313618223575&amp;parent=http%3A%2F%2Fwww.news-leader.com&amp;rpctoken=571264891&amp;_methods=onPlusOne%2C_ready%2C_close%2C_open%2C_resizeMe" style="position: static; left: 0pt; top: 0pt; width: 90px; height: 20px; visibility: visible;" tabindex="-1" vspace="0" frameborder="0" scrolling="no" width="100%"></iframe></div>
                            </span>
                            <h6>From chaos to clean up: Before and After Pictures</h6>
                        </div>
                    </div>
                </div>
<div id="container">

    <div><img alt="before" src="images/snl.before2.jpg" width="900" height="555" /></div>
    <div id="secondImage" style="visibility: hidden;height: 0px;"><img alt="after" src="images/snl.after2.jpg" width="900" height="555" /></div>

</div>

<div id="pagingMenu">
        <div style="clear: both; float: right;"><p class="photoCredit">Nathan Papes / Springfield News-Leader</p></div>
        <div style="float: left;">
                                   <div style="font-weight:bold;color: #ACACAC;float:left;">Images: </div> 
<?php
include("paging.php");
?>
</div>
<h4>Look back at our full coverage of the <a href="http://www.news-leader.com/section/joplin/">Joplin Tornado</a> here.</h4>
<hr />
<div>
    <div id="fbcomments">
        <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://php.news-leader.com/joplin/cleanup1.php" num_posts="35" width="500"></fb:comments>
    </div>
    <div id="facebookWidget">
        <iframe src="http://www.facebook.com/plugins/likebox.php?id=63475094632&amp;width=279&amp;connections=10&amp;stream=false&amp;header=false&amp;height=265" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:279px; height:265px;" allowtransparency="true" width="279" height="265"></iframe>
    </div>
</div>
</div>
